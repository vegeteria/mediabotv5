...
def get_dub_or_raise(
    ...
    if item_details.dubs:
        return item_details.dubs[0]

    if not item_details.dubs:
        from moviebox_api.v3.models.details import DubModel
        return DubModel(
            subjectId=item_details.subject_id,
